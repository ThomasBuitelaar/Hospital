...
CREATE TABLE IF NOT EXISTS `clients` (
	...
	`client_phonenumber` varchar(50) DEFAULT NULL,
	`clien_email` varchar(50) DEFAULT NULL,
	PRIMARY KEY (`client_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=1;

INSERT INTO `clients` (`client_id`, `client_firstname`, `client_lastname`, `client_phonenumber`, `client_email`) VALUES
(1, 'Jane', 'Doe', '0612345678', 'janedoe@hermail.com'),
(2, 'John', 'Doe', '0687654321', 'johndoe@hismail.com');
